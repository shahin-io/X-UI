...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/shahin-io/x-ui/master/install.sh)
```
...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/shahin-io/x-ui/master/install.sh) 1.6.4
```
